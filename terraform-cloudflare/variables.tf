...
variable "enable_dev_port" {
  description = "Enable port 3000 for Next.js dev server (restricted to SSH CIDR blocks)"
  type        = bool
  default     = false
}
...
variable "domain_name" {
  description = "Domain name for the application (e.g., shop.yourdomain.com)"
  type        = string
  default     = ""
}
